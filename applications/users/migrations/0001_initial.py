    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ocupation', models.CharField(choices=[('0', 'Custodia'), ('1', 'Mesa'), ('2', 'Call'), ('3', 'Courrier'), ('4', 'Sig'), ('5', 'Tecnologia'), ('6', 'Administrador'), ('7', 'Cliente')], max_length=1, verbose_name='Ocupacion')),
                ('d_i', models.CharField(max_length=12, verbose_name='Documento de identidad')),
                ('is_staff', models.BooleanField(default=True)),
                ('is_active', models.BooleanField(default=False)),
                ('date_joined', models.DateTimeField(auto_now_add=True)),
                ('ciudad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_ciudad', to='cliente.ciudad')),
